...
- **SC-003**: Purely additive: no existing file modified except `prompts/interviewer/v0001/notes.md` (dated addendum); T19 can land in parallel with zero shared-line conflicts (`app/backend/agents/__init__.py` re-exports nothing by design).
